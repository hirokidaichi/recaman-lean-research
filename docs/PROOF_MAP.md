...
| 接続 | 証拠 | 残る制限 |
|---|---|---|
| 17個のmin-lag-11型とU7非両立charge、型対の符号衝突 | `PROVED-LEAN` E-079 | 周期接着はE-080 |
| φ7とφ11の像が交わらず両者単射 → \|U7∪U11min\|≤\|D\| | `PROVED-LEAN` E-080 | 全lagではない。lag≥15はE-086 |
| 155個のmin-lag-15型のCSP chargeがφ7∪φ11と非両立かつ単射 → \|U7∪U11min∪U15min\|≤\|D\| | `PROVED-PAPER` E-086 | 最小lag≥19は残る。lag-19型表は完了にしない |
| d非依存セレクタでφ7をlag-15まで延長 | `STOPPED` E-088 | 再開は155型に対する型表なしの局所障害、または閉形式potential |
