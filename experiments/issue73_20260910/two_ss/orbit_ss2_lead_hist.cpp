// SS=2 min P2 leading-run length histogram (a≥3 companions).
#include <array>
#include <cstdint>
#include <iostream>
#include <stdexcept>
...
int main(){
 ...
 std::array<N,16> leadc{}; N lead_ge16=0, ss2=0;
 std::cout<<"protocol=H-20260910-38 SS=2 leading-run histogram\n"<<std::flush;
