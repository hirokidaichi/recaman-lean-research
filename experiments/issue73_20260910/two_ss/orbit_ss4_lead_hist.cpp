// SS=4 min P2 leading-run length histogram (a≥3 companions).
#include <array>
#include <cstdint>
#include <iostream>
#include <stdexcept>
...
int main(){
 ...
 std::array<N,16> leadc{}; N lead_ge16=0, ss4=0;
 std::cout<<"protocol=H-20260910-38 SS=4 leading-run histogram\n"<<std::flush;
 ...
 if(ss4!=16455) throw std::runtime_error("ss4");
 std::cout<<"LEAD={";
